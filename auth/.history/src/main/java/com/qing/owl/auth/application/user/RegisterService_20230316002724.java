...
import com.qing.owl.auth.domain.user.model.User;
import com.qing.owl.auth.domain.user.model.UserFactory;
...
public class RegisterService {
    ...
    public void register(CreateUserCommand command) {
        User user = userFactory.create(command.getName(), command.getPhone(), command.getPassword(), command.getSex());
